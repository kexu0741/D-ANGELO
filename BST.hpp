...
struct PlayerNode
{
  ...
  PlayerNode(){}
  PlayerNode(string n, string p, int g, string c, double p1, double f, double t, double f2, double a, double r, double s, double b ,double t2, double a2, double s2, double b2, double s3, double s4,double p2,  int g2, double a3)
  {
    name = n;
    position = p;
    grade = g;
